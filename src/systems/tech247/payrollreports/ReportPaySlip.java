...
public class ReportPaySlip {
    ...
    public ReportPaySlip(Employees emp,JRDataSource data,TblPeriods period){
        ...
        groupby = DynamicReports.col.column("group",DynamicReports.type.stringType());
        build();
    }
...
//                            ))
                            ...
                            .columns(
                                    DynamicReports.col.column("TRANSACTION","name",DynamicReports.type.stringType()),
                                    DynamicReports.col.column("AMOUNT","amount",DynamicReports.type.bigDecimalType()),
                                    DynamicReports.col.column("CURRENCY","currency",DynamicReports.type.stringType()).setFixedWidth(80),
                                    groupby
