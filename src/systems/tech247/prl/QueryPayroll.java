 ...
 * @author Wilfred
 */
public class QueryPayroll implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<TblPayroll> list;
    ...
    public QueryPayroll(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Payroll..");
                ph.start();
                DataAccess da = new DataAccess();
                List<TblPayroll> list = da.searchPayroll();
                for (TblPayroll e: list){
     ...
     * @return the list
     */
    public List<TblPayroll> getList() {
        return list;
    }
