 ...
 * @author Wilfred
 */
public class QueryPayrollCodeGroups implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    int year;
    private List<TblPayrollCodeGroups> list;
    
    
    
    public QueryPayrollCodeGroups(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Payroll Code Groups..");
                ph.start();
                DataAccess da = new DataAccess();
                List<TblPayrollCodeGroups> list = DataAccess.getPayrollCodeGroups();
                        for (TblPayrollCodeGroups e: list){
     ...
     * @return the list
     */
    public List<TblPayrollCodeGroups> getList() {
        return list;
    }
