...
public class FactoryPLRSetup extends ChildFactory<SetupItem> {
    ...
    protected boolean createKeys(List<SetupItem> toPopulate) {
        ...
        toPopulate.add(new SetupItem("Pay Points",Children.create(new FactoryPaypoints(true), true)));
        toPopulate.add(new SetupItem("Cost Centers",Children.create(new FactoryCostCenters(true), true)));
