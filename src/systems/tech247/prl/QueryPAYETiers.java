 ...
 * @author Wilfred
 */
public class QueryPAYETiers implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    int year;
    private List<PrlMonthlyPAYETableTiers> list;
    
    
    
    public QueryPAYETiers(final int year){
        this.year = year;
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading PAYE Tiers..");
                ph.start();
                DataAccess da = new DataAccess();
                List<PrlMonthlyPAYETableTiers> list = DataAccess.searchPayeTiers(year);
                        for (PrlMonthlyPAYETableTiers e: list){
     ...
     * @return the list
     */
    public List<PrlMonthlyPAYETableTiers> getList() {
        return list;
    }
