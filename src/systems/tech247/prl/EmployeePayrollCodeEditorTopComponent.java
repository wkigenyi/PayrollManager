 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.prl//EmployeePayrollCodeEditor//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "EmployeePayrollCodeEditorTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_NEVER
)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "systems.tech247.prl.EmployeePayrollCodeEditorTopComponent")
...
@Messages({
    "CTL_EmployeePayrollCodeEditorAction=EmployeePayrollCodeEditor",
    "CTL_EmployeePayrollCodeEditorTopComponent=New Employee Payroll Code",
    "HINT_EmployeePayrollCodeEditorTopComponent="
})
public final class EmployeePayrollCodeEditorTopComponent extends TopComponent implements LookupListener {
    ...
    public EmployeePayrollCodeEditorTopComponent(){
        this(null);
    }
    
    public EmployeePayrollCodeEditorTopComponent(Employees e){
        this(e,null);
    }

    public EmployeePayrollCodeEditorTopComponent(Employees emp,TblEmployeePayrollCode code) {
        initComponents();
        setName(Bundle.CTL_EmployeePayrollCodeEditorTopComponent());
        setToolTipText(Bundle.HINT_EmployeePayrollCodeEditorTopComponent());
        this.emp = emp;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jLabel1.text")); // NOI18N

        jtCodeName.setText(org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jtCodeName.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jcbIsActive, org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jcbIsActive.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jLabel5.text")); // NOI18N
        ...
        jftAmount.setText(org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jftAmount.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jLabel6.text")); // NOI18N
        ...
        jftAmount1.setText(org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jftAmount1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jLabel7.text")); // NOI18N

        jtCurrency.setText(org.openide.util.NbBundle.getMessage(EmployeePayrollCodeEditorTopComponent.class, "EmployeePayrollCodeEditorTopComponent.jtCurrency.text")); // NOI18N
    ...
    private class PayrollCodeSavable extends AbstractSavable{
        ...
        EmployeePayrollCodeEditorTopComponent tc(){
            return EmployeePayrollCodeEditorTopComponent.this;
        }
