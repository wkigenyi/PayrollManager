 ...
 * @author Wilfred
 */
public class QueryCostCenters implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    int year;
    private List<TblCostCenter> list;
    
    
    
    public QueryCostCenters(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Cost Centers..");
                ph.start();
                DataAccess da = new DataAccess();
                List<TblCostCenter> list = da.getCostCenters();
                        for (TblCostCenter e: list){
     ...
     * @return the list
     */
    public List<TblCostCenter> getList() {
        return list;
    }
