 ...
 * @author Wilfred
 */
public class QueryPayPoints implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<TblPaypoint> list;
    
    
    
    public QueryPayPoints(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Pay Points..");
                ph.start();
                DataAccess da = new DataAccess();
                List<TblPaypoint> list = da.searchPayPoint();
                        for (TblPaypoint e: list){
     ...
     * @return the list
     */
    public List<TblPaypoint> getList() {
        return list;
    }
