 ...
 * @author Wilfred
 */
public class QueryFinancialYears implements Lookup.Provider {
    ...
    public QueryFinancialYears(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Payrol Years..");
                ph.start();
                DataAccess da = new DataAccess();
                List<TblPeriods> list = da.getPayrollPeriods();
                for (TblPeriods e: list){
                        if(!getList().contains(e.getPeriodYear())){
                            getList().add(e.getPeriodYear());
                        }
