 ...
 * @author Wilfred
 */
public class QueryPayrollPeriod implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<TblPeriods> list;
    
    
    
    public QueryPayrollPeriod(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Payroll Periods..");
                ph.start();
     ...
     * @return the list
     */
    public List<TblPeriods> getList() {
        return list;
    }
