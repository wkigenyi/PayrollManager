 ...
 * @author Wilfred
 */
public class QueryPayrollCodes implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<TblPayrollCode> list;
    
    
    
    public QueryPayrollCodes(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Payroll Codes..");
                ph.start();
                DataAccess da = new DataAccess();
                List<TblPayrollCode> list = da.searchPayrollCode(sqlString);
                        for (TblPayrollCode e: list){
     ...
     * @return the list
     */
    public List<TblPayrollCode> getList() {
        return list;
    }
