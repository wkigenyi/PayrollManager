...
import systems.tech247.prl.QueryLHTTiers;
 ...
 * @author Admin
 */
public class PLRLHTPanel extends javax.swing.JPanel implements ExplorerManager.Provider, LookupListener{
    
    ExplorerManager em = UtilityPLR.emPLRLHTTiers;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(PLRLHTPanel.class, "PLRLHTPanel.jLabel3.text")); // NOI18N

        searchPeriod.setBackground(new java.awt.Color(51, 255, 255));
        searchPeriod.setText(org.openide.util.NbBundle.getMessage(PLRLHTPanel.class, "PLRLHTPanel.searchPeriod.text")); // NOI18N
...
//            search.setText(e.getSurName() + " " + e.getOtherNames());
            ...
            if(obj instanceof Integer){
                ...
                searchPeriod.setText(((Integer) obj)+"");
                QueryLHTTiers query =  new QueryLHTTiers((Integer)obj);
